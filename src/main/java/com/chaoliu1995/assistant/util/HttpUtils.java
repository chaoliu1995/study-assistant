...
public class HttpUtils {
    ...
    private static Map<String,String> simulationBrowserMap = new HashMap<>();
    static{
        simulationBrowserMap.put("User-Agent","Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:63.0) Gecko/20100101 Firefox/63.0");
    }
     ...
     * @return
     */
    public static String simulationBrowserGet(String url){
        return execute(OkHttp.builder().url(url).headerMap(simulationBrowserMap).build());
    }
