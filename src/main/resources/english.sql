...
CREATE TABLE `cn_definition` (
  ...
  `defn` varchar(1000) DEFAULT NULL COMMENT '释义',
  PRIMARY KEY (`id`)
...
CREATE TABLE `en_defn_adj` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `word_id` int(11) DEFAULT NULL COMMENT '单词id',
  `adj` varchar(1000) DEFAULT NULL COMMENT '形容词解释',
  PRIMARY KEY (`id`)
...
CREATE TABLE `en_defn_adv` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `word_id` int(11) DEFAULT NULL COMMENT '单词id',
  `adv` varchar(1000) DEFAULT NULL COMMENT '副词解释',
  PRIMARY KEY (`id`)
...
CREATE TABLE `en_defn_art` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `word_id` int(11) DEFAULT NULL COMMENT '单词id',
  `art` varchar(1000) DEFAULT NULL COMMENT '冠词解释',
  PRIMARY KEY (`id`)
...
CREATE TABLE `en_defn_conj` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `word_id` int(11) DEFAULT NULL COMMENT '单词id',
  `conj` varchar(1000) DEFAULT NULL COMMENT '连词解释',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `en_defn_interj` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `word_id` int(11) DEFAULT NULL COMMENT '单词id',
  `interj` varchar(1000) DEFAULT NULL COMMENT '感叹词解释',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `en_defn_n` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `word_id` int(11) DEFAULT NULL COMMENT '单词id',
  `n` varchar(1000) DEFAULT NULL COMMENT '名词解释',
  PRIMARY KEY (`id`)
...
CREATE TABLE `en_defn_num` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `word_id` int(11) DEFAULT NULL COMMENT '单词id',
  `num` varchar(1000) DEFAULT NULL COMMENT '数词解释',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `en_defn_prep` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `word_id` int(11) DEFAULT NULL COMMENT '单词id',
  `prep` varchar(1000) DEFAULT NULL COMMENT '介词解释',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `en_defn_pron` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `word_id` int(11) DEFAULT NULL COMMENT '单词id',
  `pron` varchar(1000) DEFAULT NULL COMMENT '代词解释',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `en_defn_v` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `word_id` int(11) DEFAULT NULL COMMENT '单词id',
  `v` varchar(1000) DEFAULT NULL COMMENT '动词解释',
  PRIMARY KEY (`id`)
